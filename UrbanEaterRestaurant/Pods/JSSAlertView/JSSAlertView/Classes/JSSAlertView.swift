...
open class JSSAlertView: UIViewController {
    ...
    var titleFont = "Roboto-Light"
    var textFont = "Roboto-Regular"
    var buttonFont = "Roboto-Medium"
    ...
    open override func viewDidLayoutSubviews() {
        ...
        if !noButtons {
            ...
            if cancelButton != nil {
                ...
                cancelButton.frame = CGRect(x: 8, y: yPos+10, width: buttonWidth - 0.5 - 8, height: buttonHeight)
            ...
            dismissButton.frame = CGRect(x: buttonX+8, y: yPos+10, width: buttonWidth - 16, height: buttonHeight)
            ...
            if cancelButtonLabel != nil {
                cancelButtonLabel.font = UIFont(name: buttonFont, size: 15)
            }
    ...
    public func showAlert(_ viewController: UIViewController,
        ...
        alertBackgroundView.layer.cornerRadius = 5.0
        ...
        titleLabel.font = UIFont(name: titleFont , size: 19)
        ...
        if !noButtons {
            ...
            if title.range(of:"Offline") != nil {
                ...
                dismissButton.backgroundColor = #colorLiteral(red: 0.2509803922, green: 0.2901960784, blue: 0.4078431373, alpha: 1)
            }
            ...
            if cancelButtonText != nil {
                ...
                if title.range(of:"Offline") != nil {
                    print("exists")
                    cancelButton.backgroundColor = #colorLiteral(red: 0.2509803922, green: 0.2901960784, blue: 0.4078431373, alpha: 1)
                }else{
