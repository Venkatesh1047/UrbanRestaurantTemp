...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func SetInitialViewController()
    {
        if UserDefaults.standard.value(forKey: "restaurantInfo") != nil
        {
            ...
            //            let controller : UIViewController = storyboard.instantiateViewController(withIdentifier: "TabBarControllerVCID")
...
//                (UIApplication.shared.delegate as! AppDelegate).window?.makeToast("Your Account has been Deleted. Please contact Admin", duration: 3.0 , position: .center)
//                IsAdminDeactivate=false
//            }
        }
    }
